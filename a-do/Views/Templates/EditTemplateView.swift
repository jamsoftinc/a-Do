...
struct EditTemplateView: View {
    ...
    init(template: ReminderTemplate) {
        ...
        self._templateTitle = State(initialValue: template.title)
        self._templateDetails = State(initialValue: template.details ?? "")
        self._selectedCategory = State(initialValue: template.category)
        self._selectedIcon = State(initialValue: template.icon)
        self._selectedColor = State(initialValue: template.colorHex)
        self._selectedPriority = State(initialValue: template.priorityEnum)
    }
...
#Preview {
    let template = ReminderTemplate(name: "Daily Standup", title: "Daily team standup meeting", category: "Work")
